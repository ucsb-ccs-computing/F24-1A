...
* [Create a new repo, and clone it to your local directory](#step2){: data-ajax="false"}
...
Copy the skeleton to your local lab03 repo using the following command, <strong>REMEMBER</strong> to change the directory name in the commands below to your own directory's name, in this lab we simply use lab03_jgaucho as a example for your local git directory:

```
  cp /cs/faculty/richert/public_html/cs16/lab03/* ~/cs16/lab03_jgaucho/
```

After doing this command, if you cd into ~/cs16/lab03_jgaucho/ and use the ls command, you should see several .cpp files:
...
* Navigate to your ~/cs16/lab03_jgaucho directory, the one containing your code for this week's lab.
<pre>
-bash-4.2$ cd ~/cs16/lab03_jgaucho
</pre>
