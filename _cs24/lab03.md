...
* Create a repo for this lab on the your github account following the process described in previous labs and also following the correct naming convention
...
* Change into your lab03 git directory
